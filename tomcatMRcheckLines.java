[hadoop@open003 test]$ cat Test_2.java 
/**
 * Created by buyu on 16-11-7.
 */
...
public class Test_2 extends Configured implements Tool {
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, Text>
    {
        public void map ( LongWritable key, Text value, Context context ) throws IOException, InterruptedException
        {
            ...
            try
            {
                ...
                String c_ip = lineSplit[0];
                String email = lineSplit[1];
                String remote_user = lineSplit[2];
                String status = lineSplit[8];
                String bytes_sent = lineSplit[9];

                Text out = new Text(c_ip+" "+email+" "+remote_user+" "+status+" "+bytes_sent);




                context.write(new Text(), out); //输出
            }
    ...
    public int run(String[] args) throws Exception
    {
        ...
        FileOutputFormat.setOutputPath(job, new Path(args[1]));         // 清理已存在的输出文件
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        if ( args.length != 3 )
        {
            ...
            System.err.println("Example: hadoop jar /home/hadoop/test/Test_2.jar hdfs://masters/data/input360/* hdfs://masters/output360/data hadoop");
